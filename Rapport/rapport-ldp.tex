...
l'aide. Ensuite, nous appelons la fonction show de Fl_Window sur l'instance de
HelpWindow.
\par
...
fonction shown de Fl_Window), nous appelons la fonction Fl::wait. La fenêtre est
...
statiques, nous étions donc obligés d'appeler notre Contrôleur dans le
