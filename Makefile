...
main: Constantes.hpp MainWindow.o main.cpp Canvas.o Cell.o #Wall.o Player.o Board.o
	${COMPILER} -o jeu Constantes.hpp MainWindow.o main.cpp Canvas.o Cell.o ${FLAGS}
